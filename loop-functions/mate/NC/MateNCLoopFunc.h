...
#ifndef MATE_NC_LOOP_FUNC_H
#define MATE_NC_LOOP_FUNC_H
...
class MateNCLoopFunction : public CoreLoopFunctions {

   public:
      MateNCLoopFunction();
      MateNCLoopFunction(const MateNCLoopFunction& orig);
      virtual ~MateNCLoopFunction();
      ...
      std::vector<MateNCLoopFunction::CAgent> PickAgentsInBlackSpot();

      std::vector<MateNCLoopFunction::CAgent> PickAgentsOfSameID(std::vector<CAgent>& agents, UInt32 un_GroupID);
