...
class ForagingTwoSpotsLogLoopFunction: public CoreLoopFunctions {
  protected:
    int m_unTimeStep;
  public:
    ForagingTwoSpotsLogLoopFunction();
    ForagingTwoSpotsLogLoopFunction(const ForagingTwoSpotsLogLoopFunction& orig);
    virtual ~ForagingTwoSpotsLogLoopFunction();
