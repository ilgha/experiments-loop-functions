...
#include "ForagingTwoSpotsLogLoopFunc.h"

/****************************************/
/****************************************/

ForagingTwoSpotsLogLoopFunction::ForagingTwoSpotsLogLoopFunction() {
  m_fRadius = 0.15;
  m_fNestLimit = -0.6;
...
ForagingTwoSpotsLogLoopFunction::ForagingTwoSpotsLogLoopFunction(const ForagingTwoSpotsLogLoopFunction& orig) {
...
void ForagingTwoSpotsLogLoopFunction::Init(TConfigurationNode& t_tree) {
...
void ForagingTwoSpotsLogLoopFunction::Destroy() {}

/****************************************/
/****************************************/

argos::CColor ForagingTwoSpotsLogLoopFunction::GetFloorColor(const argos::CVector2& c_position_on_plane) {
...
Real ForagingTwoSpotsLogLoopFunction::AreaTriangle(CVector2& c_point_a, CVector2& c_point_b, CVector2& c_point_c) {
...
bool ForagingTwoSpotsLogLoopFunction::IsWithinTriangle(CVector2& c_point_q, CVector2& c_point_a, CVector2& c_point_b, CVector2& c_point_c) {
...
void ForagingTwoSpotsLogLoopFunction::Reset() {
...
void ForagingTwoSpotsLogLoopFunction::PostStep() {
...
Real ForagingTwoSpotsLogLoopFunction::GetObjectiveFunction() {
...
CVector3 ForagingTwoSpotsLogLoopFunction::GetRandomPosition() {
  Real temp;
...
REGISTER_LOOP_FUNCTIONS(ForagingTwoSpotsLogLoopFunction, "foraging_log_loop_functions");
