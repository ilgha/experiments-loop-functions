...
#include "SCAhalfLoopFunc.h"

/****************************************/
/****************************************/

SCAhalfLoopFunction::SCAhalfLoopFunction() {
  m_fSpotRadius = 0.3;
...
SCAhalfLoopFunction::SCAhalfLoopFunction(const SCAhalfLoopFunction& orig) {}
...
/****************************************/
void SCAhalfLoopFunction::Destroy() {}

/****************************************/
/****************************************/

void SCAhalfLoopFunction::Reset() {
  m_fObjectiveFunction = 0;
...
void SCAhalfLoopFunction::Init(TConfigurationNode& t_tree) {
...
argos::CColor SCAhalfLoopFunction::GetFloorColor(const argos::CVector2& c_position_on_plane) {
...
bool SCAhalfLoopFunction::IsInShelter(CVector2& c_position) {
...
void SCAhalfLoopFunction::PostStep() {
...
void SCAhalfLoopFunction::PostExperiment() {
...
Real SCAhalfLoopFunction::GetObjectiveFunction() {
...
CVector3 SCAhalfLoopFunction::GetRandomPosition() {
...
REGISTER_LOOP_FUNCTIONS(SCAhalfLoopFunction, "sca_half_loop_functions");
