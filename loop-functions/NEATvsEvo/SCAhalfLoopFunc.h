...
#ifndef SCA_HALF_LOOP_FUNC_H
#define SCA_HALF_LOOP_FUNC_H
...
class SCAhalfLoopFunction : public CoreLoopFunctions {

   public:
      SCAhalfLoopFunction();
      SCAhalfLoopFunction(const SCAhalfLoopFunction& orig);
      virtual ~SCAhalfLoopFunction();
