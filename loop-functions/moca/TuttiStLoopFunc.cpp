...
void TuttiStLoopFunction::PositionArena() {
...
void TuttiStLoopFunction::RemoveArena() {
...
Real TuttiStLoopFunction::GetArenaRadious() {
...
bool TuttiStLoopFunction::IsEven(UInt32 unNumber) {
    bool even;
    if((unNumber%2)==0)
       even = true;
    else
