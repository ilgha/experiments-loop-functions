...
#include "BabyForagingTwoSpotsLoopFunc.h"

/****************************************/
/****************************************/

BabyForagingTwoSpotsLoopFunction::BabyForagingTwoSpotsLoopFunction() {
  m_fRadius = 0.06;
  m_fNestLimit = -0.18;
  m_cCoordSpot1 = CVector2(0.20,0);
  m_cCoordSpot2 = CVector2(-0.20,0);
...
BabyForagingTwoSpotsLoopFunction::BabyForagingTwoSpotsLoopFunction(const BabyForagingTwoSpotsLoopFunction& orig) {
}

/****************************************/
/****************************************/

void BabyForagingTwoSpotsLoopFunction::Init(TConfigurationNode& t_tree) {
...
void BabyForagingTwoSpotsLoopFunction::Destroy() {}

/****************************************/
/****************************************/

argos::CColor BabyForagingTwoSpotsLoopFunction::GetFloorColor(const argos::CVector2& c_position_on_plane) {
  ...
  if (vCurrentPoint.GetY() < m_fNestLimit) {
    Real fMaxDim = 0.33;
    Real fLengthWall = 0.18;
    Real fWidthWall = 0.01;
    Real fPI = 3.14159265;
    CVector2 cCenter(0, m_fNestLimit);
    CVector2 cTop(0.3 + fWidthWall, m_fNestLimit);
    CVector2 cBottom(-0.3 - fWidthWall, m_fNestLimit);
    CVector2 cAngle1(0.3 - ARGOS_COS(60*fPI/180.0f)*fLengthWall/2 + fWidthWall, m_fNestLimit - (ARGOS_SIN(60*fPI/180.0f)*fLengthWall/2) - fWidthWall);
    CVector2 cAngle2(fLengthWall/2 + fWidthWall, -fMaxDim);
    CVector2 cAngle3(-(fLengthWall/2 + fWidthWall), -fMaxDim);
    CVector2 cAngle4(-0.3 + ARGOS_COS(60*fPI/180.0f)*fLengthWall/2 - fWidthWall, m_fNestLimit - (ARGOS_SIN(60*fPI/180.0f)*fLengthWall/2) - fWidthWall);
...
Real BabyForagingTwoSpotsLoopFunction::AreaTriangle(CVector2& c_point_a, CVector2& c_point_b, CVector2& c_point_c) {
...
bool BabyForagingTwoSpotsLoopFunction::IsWithinTriangle(CVector2& c_point_q, CVector2& c_point_a, CVector2& c_point_b, CVector2& c_point_c) {
...
void BabyForagingTwoSpotsLoopFunction::Reset() {
...
void BabyForagingTwoSpotsLoopFunction::PostStep() {
...
Real BabyForagingTwoSpotsLoopFunction::GetObjectiveFunction() {
...
CVector3 BabyForagingTwoSpotsLoopFunction::GetRandomPosition() {
  Real temp;
...
void BabyForagingTwoSpotsLoopFunction::PostExperiment()
{
    LOG << m_fObjectiveFunction << std::endl;
}

REGISTER_LOOP_FUNCTIONS(BabyForagingTwoSpotsLoopFunction, "baby_foraging_loop_functions");
