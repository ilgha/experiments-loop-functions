...
class GuidedShelterLogLoopFunc: public CoreLoopFunctions {
  protected:
  int m_unTimeStep;
  public:
    GuidedShelterLogLoopFunc();
    GuidedShelterLogLoopFunc(const GuidedShelterLogLoopFunc& orig);
    virtual ~GuidedShelterLogLoopFunc();
