...
#include "GuidedShelterLogLoopFunc.h"

/****************************************/
/****************************************/

GuidedShelterLogLoopFunc::GuidedShelterLogLoopFunc() {
  m_fRadius = 0.3;
...
void GuidedShelterLogLoopFunc::Destroy() {}

void GuidedShelterLogLoopFunc::Init(TConfigurationNode& t_tree) {
...
void GuidedShelterLogLoopFunc::GetLightPosition() {
...
bool GuidedShelterLogLoopFunc::PointIsInBlackArea(CVector2 point) {
...
bool GuidedShelterLogLoopFunc::PointIsInWhiteArea(CVector2 point) {
    Real shelter_y_limit = -(ARENA_DEPTH - m_fOffset - m_fDepth);
    Real shelter_x_limit = m_fWidth/2;
...
void GuidedShelterLogLoopFunc::Reset() {
  m_fObjectiveFunction = 0;
  m_unScoreSpot = 0;
...
argos::CColor GuidedShelterLogLoopFunc::GetFloorColor(const argos::CVector2& c_position_on_plane) {
...
void GuidedShelterLogLoopFunc::PostStep() {
    m_unScoreSpot = 0;
...
void GuidedShelterLogLoopFunc::PostExperiment() {
...
Real GuidedShelterLogLoopFunc::GetObjectiveFunction() {
...
CVector3 GuidedShelterLogLoopFunc::GetRandomPosition() {
  Real a;
  Real b;
  Real temp;
...
REGISTER_LOOP_FUNCTIONS(GuidedShelterLogLoopFunc, "guided_shelter_log_loopfunc");
