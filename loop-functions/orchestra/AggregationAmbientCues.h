...
class AggregationAmbientCues: public CoreLoopFunctions {
  public:
    AggregationAmbientCues();
    AggregationAmbientCues(const AggregationAmbientCues& orig);
    virtual ~AggregationAmbientCues();
