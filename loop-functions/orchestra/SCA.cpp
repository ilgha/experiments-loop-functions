...
void SCA::Init(TConfigurationNode& t_tree) {
...
argos::CColor SCA::GetFloorColor(const argos::CVector2& c_position_on_plane) {
...
bool SCA::IsInShelter(CVector2& c_position) {
...
CVector3 SCA::GetRandomPosition() {
...
REGISTER_LOOP_FUNCTIONS(SCA, "sca");
