/**
  * @file <loop-functions/example/CFA.cpp>
  *
...
argos::CColor CFA::GetFloorColor(const argos::CVector2& c_position_on_plane) {
...
CVector3 CFA::GetRandomPosition() {
  Real temp;
...
CVector2 CFA::GetRandomPointInArena() {
...
bool CFA::IsOnBlackArea(CVector2& c_epuck_pos) {
...
Real CFA::GetClosestEpuckDistanceFromPoint(CVector2& c_random_point) {
...
REGISTER_LOOP_FUNCTIONS(CFA, "cfa");
